...
import Gotham from '../css/assets/fonts/96AFA220F80ED4389.eot';
...
const gotham = {
	...
	fontWeight: 400,
	src: `
   url(assets/fonts/96AFA220F80ED4389.eot)
  local('?'),
		url(assets/fonts/96AFA220F80ED4389.eot?#hco) format('embedded-opentype')
  `,
};
